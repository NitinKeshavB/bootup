...
, obt as (
    ...
    from fct_workorder
    left join dim_products on fct_workorder.product_key = dim_products.product_key 
    left join dim_scrapreason on fct_workorder.scrapreason_key = dim_scrapreason.scrapreason_key 
    left join dim_date as start_date on fct_workorder.start_date_key = start_date.date_key 
    left join dim_date as end_date on fct_workorder.end_date_key = end_date.date_key 
    left join dim_date as due_date on fct_workorder.due_date_key = due_date.date_key 
)
