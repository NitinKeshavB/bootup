...
, obt as (
    ...
    left join dim_customers on fct_sales.customer_key = dim_customers.customer_key 
    left join dim_credit_cards on fct_sales.creditcard_key = dim_credit_cards.creditcard_key 
    left join dim_address on fct_sales.ship_address_key = dim_address.address_key 
    left join dim_order_status on fct_sales.order_status_key = dim_order_status.order_status_key 
