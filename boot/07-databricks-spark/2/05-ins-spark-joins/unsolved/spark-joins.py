...
gmail_accounts = sales_df.filter(# TODO )
...
sales_exploded_df = sales_df # TODO 
display(sales_exploded_df # TODO )
print(sales_exploded_df # TODO )
print(sales_exploded_df #TODO )
