...
Over the past 3 weeks, you have learnt: 
...
- **27/09/2022**: Provide a project plan. See [project plan template](project-plan-template.md). 
...
- **29/09/2022**: Work on your project in class (and outside of class) 
- **30/10/2022 - 16/10/2022**: Work on your project outside of class 
- **17/10/2022**: 7 minute presentation of your project
- **11:59pm, 17/10/2022 (AWST)**: Project submission due 
...
1. Pushing your project code to a GitHub repository 
2. Make the GitHub repository public 
3. Submit the repository link on Eduflow 
